...
Config = {
    ...
    "chromedriver_path": r"C:\Users\nguye\OneDrive\Documents\Projects\Insta-mass-account-creator\chromedriver-win64\chromedriver.exe",
    ...
    "amount_of_account": 1000, #amount of account you want to create make sure it doesnt exceed 50 for better performance
    "amount_per_proxy": 100, #this would be amont of account used if you have a you are using multiple proxies
